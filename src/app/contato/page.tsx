...
export const metadata = {
    title: "Contato",
    description: "Entre em contato conosco para solicitar um orçamento.",
};
                        ...
                        <div className="flex flex-col justify-center">
                            <AnimateIn>
                                <h1 className="text-4xl md:text-5xl font-bold font-heading mb-6 text-primary">
                                    Vamos conversar sobre seu próximo evento?
                                </h1>
                                <p className="text-lg text-gray-600 mb-12">
                                    Nossa equipe está pronta para oferecer a melhor solução em tradução e interpretação. Resposta rápida e orçamento personalizado.
                                </p>
                            </AnimateIn>
                            ...
                            <div className="space-y-8">
                                <AnimateIn delay={0.1} className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-sm text-gray-400 mt-1 block">Atendimento com Sara Goulart</span>
                                    </div>
                                </AnimateIn>
                                ...
                                <AnimateIn delay={0.2} className="flex items-start gap-4">
                                    ...
                                    <div className="space-y-4 w-full">
                                        <div>
                                            <h3 className="font-bold text-primary text-lg mb-1">São Paulo / SP</h3>
                                        ...
                                        <div>
                                            <h3 className="font-bold text-primary text-lg mb-1">Rio de Janeiro / RJ</h3>
                                        ...
                                        <div>
                                            <h3 className="font-bold text-primary text-lg mb-1">Ribeirão Preto e Região</h3>
                                        ...
                                        <div>
                                            <h3 className="font-bold text-primary text-lg mb-1">Belém / PA</h3>
                                            <p className="text-gray-600 font-medium">(11) 3090-6820 / (11) 99868-2679</p>
